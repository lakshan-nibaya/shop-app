...
export default function Home() {
  ...
  return (
    <div className="bg-gray-900 cover-photo">
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8">
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative rounded-full px-3 py-1 text-sm/6 text-black-400 ring-1 ring-black/10 hover:ring-white/20">
          ...
          <div className="text-center">
            <h1 className="text-5xl font-semibold tracking-tight text-balance text-red sm:text-7xl">
              Lakshan's Collection
            </h1>
